...
class ArtistAdminControllerTest {
    ...
    void 목록의_genre를_생략하면_필터가_없고_sort는_CREATED_DESC다() throws Exception {
        ...
        given(artistAdminService.findAll(null, null, ArtistAdminSortType.CREATED_DESC, 0, 20))
        ...
        verify(artistAdminService).findAll(null, null, ArtistAdminSortType.CREATED_DESC, 0, 20);
    }
